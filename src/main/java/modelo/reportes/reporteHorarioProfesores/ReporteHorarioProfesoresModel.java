package modelo.reportes.reporteHorarioProfesores;
...
public class ReporteHorarioProfesoresModel {
	private ReportType reportType;
	private List<ReportType> reportTypesModel;
	private ReportConfig reportConfig;
	private Map<String, Object> parameters;
	@Wire
	private Jasperreport reporteHorarioProfesores;
	
	public ReporteHorarioProfesoresModel() {
		...
		String rutaReporte = Sessions.getCurrent().getWebApp().getRealPath("/WEB-INF/include/Reportes/ReporteHorarioProfesores/HorarioProfesores.jasper");
	...
	public void initSetup(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        reporteHorarioProfesores.setParameters(parameters);
		reporteHorarioProfesores.setDataConnection(ds.getConnection());
	}
