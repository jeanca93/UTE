package modelo.reportes.reporteAsignacionMaterias;
...
public class ReporteAsignacionMaterias {
	private ReportType reportType;
	private List<ReportType> reportTypesModel;
	private ReportConfig reportConfig;
	private Map<String, Object> parameters;
	@Wire
	private Jasperreport reporteAsignacionMaterias;
	
	public ReporteAsignacionMaterias() {
	...
	public void initSetup(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        reporteAsignacionMaterias.setParameters(parameters);
		reporteAsignacionMaterias.setDataConnection(ds.getConnection());
	}
