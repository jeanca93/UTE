package modelo.reportes.reporteMaterias;
...
public class ReporteMateriasModel{
	private ReportType reportType;
	private List<ReportType> reportTypesModel;
	private ReportConfig reportConfig;
	private Map<String, Object> parameters;
	@Wire
	private Jasperreport reporteMaterias;
	
	public ReporteMateriasModel() {
		...
		String rutaReporte = Sessions.getCurrent().getWebApp().getRealPath("/WEB-INF/include/Reportes/ReporteMaterias/Materias.jasper");
	...
	public void initSetup(@ContextParam(ContextType.VIEW) Component view) throws Exception {
        ...
        reporteMaterias.setParameters(parameters);
		reporteMaterias.setDataConnection(ds.getConnection());
	}
