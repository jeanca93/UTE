...
public class AulasrecursosHome extends MydbBaseHibernateDAO{
	...
	public Aulasrecursos merge(Aulasrecursos detachedInstance) {
		...
		try {
			Aulasrecursos result = (Aulasrecursos) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Aulasrecursos findById(AulasrecursosId id) {
		...
		try {
			Aulasrecursos instance = (Aulasrecursos) sessionFactory.getCurrentSession()
	...
	public List<Aulasrecursos> findByExample(Aulasrecursos instance) {
		...
		try {
			List<Aulasrecursos> results = (List<Aulasrecursos>) sessionFactory.getCurrentSession()
					.createCriteria("entidadesDAO.Aulasrecursos").add(create(instance)).list();
